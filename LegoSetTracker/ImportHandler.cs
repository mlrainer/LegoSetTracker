...
namespace LegoSets
{
    public static class ImportHandler
    {
        ...
        public static void importSet()
        {
            ...
            Console.WriteLine("For now, look in the Lego Set Tracker project files for a JSONIMPORT folder and place the JSON in there.  File name should be import.json");
